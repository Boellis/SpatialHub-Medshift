...
class AtlasI2C:
    ...
    def __init__(self, address=None, moduletype = "", name = "", bus=None):
        ...
        self._cloud_device_response = self.cloud_device_response
    ...
    @property
    def get_cloud_device_response(self):
        return self._cloud_device_response
    ...
    def read(self, num_of_bytes=31):
        ...
        if is_valid:
            ...
            #Get just the value from device
            stripped_response = _cloud_device_response[0:4]#also might not work for pump
            sensor_info = self.get_device_info()[0:5]#0:5
            sensor_type, sensor_address = sensor_info.split(" ")
    ...
    # tayler custom function
    def query_device_data(self, command):
        '''
        write a command to the board, wait the correct timeout, 
        and read the response
        '''
